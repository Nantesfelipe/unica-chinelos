  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[320px_1fr] gap-6">
        ...
        <div>
          {carregandoDetalhes && (
            <div className="bg-white border border-[#8e8980]/20 rounded-lg p-10">
          ...
          {!carregandoDetalhes &&
            !clienteSelecionado && (
              <div className="bg-white border border-[#8e8980]/20 rounded-lg p-12 text-center">
                <User
                  size={40}
                  className="mx-auto text-[#8e8980]"
                />
                ...
                <p className="text-sm text-[#8e8980] mt-1">
                  Escolha um cliente na lista para
          ...
          {!carregandoDetalhes &&
            clienteSelecionado && (
              <div className="space-y-6">
                ...
                <div className="bg-white border border-[#8e8980]/20 rounded-lg p-6">
                  <div className="flex items-start justify-between gap-4">
                    ...
                    <div className="w-11 h-11 rounded-full bg-[#e2dacc] flex items-center justify-center">
                      <User
                        size={21}
                ...
                {/* Pedidos */}
                <div className="bg-white border border-[#8e8980]/20 rounded-lg overflow-hidden">
                  <div className="px-6 py-5 border-b border-[#8e8980]/20">
                  ...
                  {clienteSelecionado.pedidos
                    ...
                    <div className="p-10 text-center">
                      <p className="text-sm text-[#8e8980]">
                        Este cliente ainda não realizou
                        nenhum pedido.
                      </p>
                    </div>
                  ) : (
