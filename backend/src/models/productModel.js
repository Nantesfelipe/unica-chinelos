...
async function criarProdutos({nome, descricao, preco, categoriaId, destaque, promocao}){
...
module.exports = { criarProdutos, listarProdutos, buscarProdutosPorId, atualizarProduto, excluirProduto };